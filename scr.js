...
let removeBtn = document.querySelector(".rbut");
let mainCont = document.querySelector(".mc");
let modalCont = document.querySelector(".okm");
let textareaCont = document.querySelector(".tc");
